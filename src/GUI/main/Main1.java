...
import GUI.component.PanelLoginAndRegister;
import GUI.component.PanelVerifyCode;
...
import GUI.service.ServiceMail;
import GUI.service.ServiceUser;
    ...
    private void register(){
        ...
        try {
            if(service.checkDuplicateEmail(user.getEmail())){
                showMessage(Message.MessageType.ERROR,"Email is already exist");
            }else{
