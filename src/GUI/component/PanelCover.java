...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        title.setFont(new Font("sansserif",1,22));
        title.setForeground(new Color(245,245,245));
        add(title);
        subtitle= new JLabel("Royal TheDreamers");
        subtitle.setFont(new Font("sansserif",1,24));
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(0, 0, Color.decode("#7BC6CC"), 0, getHeight(), Color.decode("#BE93C5"));
        g2.setPaint(gp);
